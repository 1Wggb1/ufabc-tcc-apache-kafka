...
\begin{document}
  ...
  \begin{itemize}
    ...
    \item \textbf{Partições}: São divisões de um tópico que armazenam eventos de forma ordenada e imutável. Permite a replicação dos eventos em diversos brokers garantiando a alta disponibilidade, além de permitir a escalabiliade dos consumidores, onde um consumidor pode ser escalado horizontalmente e fazer o processamento em paralelo os eventos das partições em um tópico (consumer group).
  ...
  \subsubsection{Buffer}
  São os tópicos e partições onde os eventos são armazenados. Backpressure acontece no fato dos eventos serem guardados para futuro processamento sem sobrecarga dos consumidores.
  ...
  Modelo que permite a independência de produtores e consumidores de eventos. Onde os consumidores recuperam os eventos ativamente de tempos em tempos. O modelo favorece o backpressure, pois os consumidores recuperam os eventos quando estiverem disponíveis para o processamento.
