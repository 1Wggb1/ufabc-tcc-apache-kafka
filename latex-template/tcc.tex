...
\begin{document}
  ...
  É um mecanismo que faz a compatibilização de velocidade de produtor e consumidor \cite{kurose2013redes}, o que pode fazer com que os dados produzidos sejam recusados por um período até o consumidor consiga processar os dados. O controle de fluxo está presente no protocolo TCP, onde os dados são armazenados no buffer do consumidor, e de acordo com a  saturação do buffer o controle de fluxo passa a recursar mensagem do produtor. Além disso, o produtor analisa se o buffer do consumidor está cheio para evitar transmitir dados que não serão processados.
